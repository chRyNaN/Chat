...
class ProjectDependencyAdapter @Inject constructor(private val listener: ProjectDependencySelectedListener) :
    ...
    override fun onCreateView(parent: ViewGroup, viewType: ViewType): View =
        LayoutInflater.from(parent.context).inflate(R.layout.adapter_project_dependency, parent, false)
    ...
    override fun onBindItem(view: View, item: ProjectDependencyItemViewModel) {
        view.apply {
            ...
            projectDependencyDescriptionTextView?.visibility = if (item.description == null) View.GONE else View.VISIBLE
